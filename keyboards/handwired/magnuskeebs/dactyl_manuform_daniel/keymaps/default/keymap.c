 ...
 */
    [_QWERTY] = LAYOUT_split_5x6_6(
        ...
        KC_ESC,   KC_1,   KC_W,     KC_E,     KC_R,    KC_T,             KC_Y,     KC_U,     KC_I,     KC_O,     KC_0,     KC_GRV,
        ...
        KC_LSFT,  KC_Z,   KC_LBRC,  KC_RBRC,  KC_NO,   KC_NO,            KC_NO,    KC_NO,    KC_PPLS,  KC_EQL,   KC_SLSH,  KC_RSFT,
        KC_NO, 	  KC_NO,  KC_NO, 	KC_SPC,   KC_TAB,  KC_HOME,          KC_END,   KC_DEL,   KC_ENT,   KC_NO,    KC_NO,    KC_NO,
        KC_NO, 	  KC_NO,  KC_NO,    MO(1),    KC_BSPC, KC_GRV,           KC_RGUI,  KC_RALT,  MO(2),    KC_NO,    KC_NO,    KC_NO
    ),
 ...
 */
    [_ADJUST] = LAYOUT_split_5x6_6(
        ...
        KC_NO, 	  KC_NO,   KC_NO, 	 XXXXXXX,  XXXXXXX,  XXXXXXX,          XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_NO,    KC_NO,    KC_NO,
